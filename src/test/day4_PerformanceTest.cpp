...
static void BM_GridChallenge_case1(benchmark::State &state)
{
...
BENCHMARK(BM_GridChallenge_case1);

static void BM_GridChallenge_case2(benchmark::State &state)
{
...
BENCHMARK(BM_GridChallenge_case2);

static void BM_GridChallenge_case3(benchmark::State &state)
{
